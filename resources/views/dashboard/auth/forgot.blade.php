    ...
    <div class="login-register"
        ...
        <div class="login-box card">
            <div class="card-body">
                ...
                <form method="post" action="{{route('dashboard.submitForgot')}}">
                    ...
                    <div class="form-group ">
                        <div class="col-xs-12">
                                <h3><a href="{{route('dashboard.login')}}"><i class="ti-arrow-right"></i></a> @lang(' استرجاع الحساب')</h3>
                            <p class="text-muted">@lang('ادخل بريدك الالكتروني و سنقوم بارسال التعليمات لك')</p>
                        </div>
                    </div>
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input class="form-control" type="email" name="email" required placeholder="@lang('البريد الاكتروني')"> </div>
                    </div>
                    <div class="form-group text-center m-t-20">
                        <div class="col-xs-12">
                            <button class="btn btn-primary btn-lg btn-block text-uppercase waves-effect waves-light" type="submit">@lang('ارسال')</button>
                        </div>
                    </div>
                </form>
            </div>
